...
extern struct IMU_settings settings;
 ...
 */
// nrfx_err_t read_register(nrf_drv_twi_t twi_instance, uint8_t device_addr, uint8_t register_addr, uint8_t *p_data, uint8_t bytes, bool no_stop);
 ...
 */
uint16_t LSM6DS3_read_FIFO_buffer(void);
