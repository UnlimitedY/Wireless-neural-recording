...
// #define AUTOCONFIG // use autoconfig (Yes it works pretty well!) this value will change the baseline value
...
bool MPR121::begin(uint8_t num_electrode) {
  ...
  // Rising： data > baseline
  writeRegister(MPR121_MHDR, 0x01);
  writeRegister(MPR121_NHDR, 0x01);
  writeRegister(MPR121_NCLR, 0x0E); // 0x08,设定的比默认更慢，需要给多的时间
  ...
  writeRegister(MPR121_CONFIG1, 0xff); // default, 63uA charge current 为了应对无线噪声
